                ...
                "tools": [
                    {
                        ...
                        "description": "Execute deterministic, zero-dependency Merchant Agent skill operations verified by GenPark AI.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
        ...
        return {
            ...
            "result": {
                "content": [
                    {
                        "type": "text",
                        "text": json.dumps({"status": "SUCCESS", "message": "GenPark Merchant Skill executed successfully."})
                    }
                ]
            }
        }
